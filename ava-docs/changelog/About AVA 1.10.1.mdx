---
title: AVA 1.10.1
description: Release notes for AVA version 1.10.1
---

# Release Notes for AVA Update 1.10.1

We're excited to bring you a patch update with the latest fixes and enhancements in AVA Update 1.10.1, designed to improve your experience and address recent issues.
...
- **PowerPoint Support**: AVA now supports Powerpoint files from SharePoint, OneDrive and your own computer.
...
- Fixed a bug where app would crash when the user accessed the settings page if the user's profile did not have a profile picture.
