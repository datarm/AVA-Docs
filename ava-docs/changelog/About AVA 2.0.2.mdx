---
title: AVA 2.0.2
description: Release notes for AVA version 2.0.2
---

# Release Notes for AVA Update 2.0.2
...
- In certain instances, AVA would crash when a user deleted a task. She doesn't do that now.
- Fixed a bug where descriptions in a task step were not saving properly.
