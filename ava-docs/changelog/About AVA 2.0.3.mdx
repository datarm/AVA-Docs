---
title: AVA 2.0.3
description: Release notes for AVA version 2.0.3
---

# Release Notes for AVA Update 2.0.3
...
- Added handling for non-US phone numbers.
- Created a smoother experience when loading recent files in the Search tab
