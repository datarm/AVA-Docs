---
title: AVA 2.0.1
description: Release notes for AVA version 2.0.1
---

# Release Notes for AVA Update 2.0.1
...
- Fixed a small empty state bug when getting corpus information.
- Initially corpus embeddings were happening internally. We updated AVA to do those embeddings within the customer's own Azure tenant.
- Fixed a bug that cause a crash if the user didn't have a phone number.
