...
<AccordionGroup>
  <Accordion title="Can I deploy AVA on-premises?">
    Yes. AVA can be deployed in your own infrastructure using Kubernetes, Docker Compose, or traditional VMs. See the [Self-Hosted Deployment](/deployment/self-hosted) guide.
  </Accordion>
